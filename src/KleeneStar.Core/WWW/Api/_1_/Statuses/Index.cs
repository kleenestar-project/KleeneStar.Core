...
namespace KleeneStar.Core.WWW.Api._1_.Statuses
{
    ...
    public sealed class Index : global::KleeneStar.Core.WebRestApi.RestApiCrudClassStructure<Model.Entities.Status>
    {
        ...
        /// </returns>
        protected override IEnumerable<Model.Entities.Status> Retrieve(IQuery<Model.Entities.Status> query, IQueryContext context, IRequest request)
        {
            return CoreHub.StatusManager.GetStatuses(query, context);
        }

        /// <summary>
        /// Retrieves the data required to create a new workflow state entity.
        /// </summary>
        /// <param name="request">
        ...
        /// </returns>
        protected override IRestApiCrudResultRetrieve RetrieveForClone(IQuery<Model.Entities.Status> query, IRequest request)
        {
            using var context = ModelHub.CreateDbContext();
            var data = CoreHub.StatusManager.GetStatuses(query, context)
                .FirstOrDefault();

            var newItem = new Model.Entities.Status()
            {
                Name = data.Name + " (Copy)",
        ...
        /// <summary>
        /// Retrieves a workflow state identified by the specified key for update operations.
        /// </summary>
        /// <param name="query">
        /// An object containing the query parameters used to filter and select index items. Cannot 
        /// be null.
        ...
        /// </param>
        /// <returns>
        /// An object containing the workflow state associated with the specified id.
        /// </returns>
        protected override IRestApiCrudResultRetrieve RetrieveForUpdate(IQuery<Model.Entities.Status> query, IRequest request)
        {
            using var context = ModelHub.CreateDbContext();
            var data = CoreHub.StatusManager.GetStatuses(query, context)
                .FirstOrDefault();
        ...
        /// <summary>
        /// Retrieves the workspace state entity identified by the specified ID in preparation for deletion.
        /// </summary>
        /// <param name="query">
        /// An object containing the query parameters used to filter and select index items. Cannot 
        /// be null.
        ...
        /// </returns>
        protected override IRestApiCrudResultRetrieveDelete RetrieveForDelete(IQuery<Model.Entities.Status> query, IRequest request)
        {
            using var context = ModelHub.CreateDbContext();
            var data = CoreHub.StatusManager.GetStatuses(query, context)
                .FirstOrDefault();
        ...
        /// </param>
        /// <param name="payload">
        /// The dynamic payload containing updated workflows.
        /// </param>
        /// <param name="request">
        ...
        /// </summary>
        /// <param name="fieldMap">
        /// The dynamic payload containing the workflows required to create the resource.
        /// </param>
        /// <param name="request">
        ...
        /// </returns>
        protected override IRestApiCrudResultCreate Create(RestApiCrudFormData fieldMap, IRequest request, out Model.Entities.Status newItem)
        {
            var id = Guid.NewGuid();
            newItem = new Model.Entities.Status(id)
            {
        ...
        /// <summary>
        /// Creates a new instance by cloning data from the specified form workflows and 
        ...
        /// </returns>
        protected override IRestApiCrudResultCreate Clone(Model.Entities.Status existingItem, RestApiCrudFormData fieldMap, IRequest request, out Model.Entities.Status newItem)
        {
            var id = Guid.NewGuid();
            newItem = new Model.Entities.Status(id)
            {
        ...
        /// </returns>
        protected override IRestApiCrudResultDelete Delete(Model.Entities.Status existingItem, IRequest request)
        {
            CoreHub.StatusManager.Remove(existingItem.Id);
