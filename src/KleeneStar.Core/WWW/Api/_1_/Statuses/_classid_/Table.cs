...
{
    /// <summary>
    /// Represents a REST API table for managing workflow states entities, providing data retrieval 
    /// and option generation functionality for workflow state records.
    /// </summary>
    ...
    public sealed class Table : KleeneStarRestApiTable<Model.Entities.Status>
    {
        ...
        public Table()
        {
            _editFormUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.Status._statusid_.Edit>();
            _cloneFormUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.Status._statusid_.Clone>();
            _deleteFormUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.Status._statusid_.Delete>();
        }
        ...
        /// </returns>
        protected override IEnumerable<RestApiTableRow> RetrieveRows(IQuery<Model.Entities.Status> query, IQueryContext context, IEnumerable<RestApiTableColumn> columns, IRequest request)
        {
        ...
        /// </returns>
        protected override IQuery<Model.Entities.Status> Filter(string filter, IQuery<Model.Entities.Status> query, IRequest request)
        {
        ...
        /// </param>
        private IEnumerable<RestApiOption> GetOptions(Model.Entities.Status row, IRequest request)
        {
        ...
        /// </returns>
        private static IUri GetUri(Model.Entities.Status row, IRequest request)
        {
            return null;
        }
        ...
        ///// </returns>
        //public override IUri GetRestApiForInlineEdit(WorkflowState row, IRequest request)
        //{
