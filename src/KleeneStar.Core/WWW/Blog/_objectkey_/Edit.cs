...
{
    /// <summary>
    /// The editing route of a single post: the prose editor, opened with the page. The URL is
    ...
    /// <see cref="Model.Entities.ObjectKind.Blog"/> is redirected to the detail view matching
    /// its own kind.
    /// </para>
    /// </remarks>
    [WebIcon<IconPen>]
