...
namespace KleeneStar.Core.WebFragment.Landing
{
    ...
    [Order(50)]
    [Cache]
    public sealed class LandingWatchedSidebarLinkFragment : LandingSidebarLinkFragment
    {
        /// <summary>
        ...
        /// </param>
        public LandingWatchedSidebarLinkFragment(IFragmentContext fragmentContext)
        ...
        /// </summary>
        protected override IUri Target => CoreHub.GetUri<global::KleeneStar.Core.WWW.Watched.Index>();

        /// <summary>
        /// Gets the resource key of the link label.
        /// </summary>
        protected override string Label => "kleenestar.core:landing.paths.watched.label";

        /// <summary>
        /// Gets the icon of the link.
        /// </summary>
        protected override IIcon Symbol => new IconEye();
    }
}
